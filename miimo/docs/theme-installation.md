...
---
**Step 4:** When the installation complete, click Activate. You will be redirected to Themes page with Miimo activated.
...
- **Step 3** – Upload the extracted Miimo folder to the **wp-content > themes** folder on your server. Make sure the folder name is **miimo**.
- **Step 4** – Log in to your WordPress Dashboard and navigate to **Appearance > Themes** and clicking the **Activate** button, for the Miimo theme.